...
|                                                                                | 22w11a    | 22w12a    | 22w13a    | 22w14a    | 22w15a    |
| ------------------------------------------------------------------------------ | --------- | --------- | --------- | --------- | --------- |
...
- [Debugify](https://modrinth.com/mod/debugify) is a Fabric mod for 1.18.2 that fixes [a whole load of vanilla bugs](https://github.com/W-OVERFLOW/Debugify/blob/1.18/PATCHED.md): it currently contains over 70 bugfixes! It also has a config screen that lets you independently toggle all the bugfixes.
